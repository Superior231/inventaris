        ...
        <div class="card-body p-4 p-lg-5">
            <div class="actions d-flex align-items-center justify-content-between mb-4">
                <div class="input-group w-auto">
                    ...
                    <input wire:model.live="search" type="search" class="form-control" placeholder="Search category..." aria-describedby="basic-addon1">
                </div>
                <a wire:navigate href="{{ route('admin.kategori.tambah') }}" class="btn btn-primary">Tambah</a>
            </div>
